...
class AppDelegate: UIResponder, UIApplicationDelegate, GIDSignInDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // Initialize sign-in
        GIDSignIn.sharedInstance().clientID = "384283421678-5is19cr2i57e40peqnt5ad7bd1tcf24i.apps.googleusercontent.com"
    ...
    // to run on iOS8 and older, must implement this deprecated method
...
//            let email = user.profile.email
            ...
            // launch TabBarController after login
            let tabbarViewController = storyboard.instantiateViewController(withIdentifier: "tabbar")
            tabbarViewController.view.frame = (self.window!.frame)
